...
import { AddContaVar } from '@/app/lib/actions'
    ...
    <div className='w-screen h-screen px-[430px] pt-20 bg-gray-200'>
      <div className='relative bg-indigo-800 w-[400px] h-[520px] shadow-lg rounded-lg'>
        ...
        <div className='absolute left-10 top-10 flex w-[80%] h-full'>
          ...
          <form action={AddContaVar} className='flex flex-col w-full h-full items-center space-y-5'>
            <input 
            ...
            <input 
            className='rounded-md w-full h-[40px]'
            type="date" placeholder='Data de Vencimento' name='data' />
            
            <input 
            className='rounded-md w-full h-[40px]'
            type="number" placeholder='Total' name='total' step=".01" />
